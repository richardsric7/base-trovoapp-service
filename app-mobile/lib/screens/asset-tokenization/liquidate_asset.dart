...
class LiquidateAsset extends StatefulWidget {
  const LiquidateAsset({Key? key}) : super(key: key);

  @override
  State<LiquidateAsset> createState() => _LiquidateAsset();
}

class _LiquidateAsset extends State<LiquidateAsset>
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    width: width / 1.2,
                    child: Text(
                      'Please send sale offer for voting in order to proceed',
                      style: TextStyle(
                        fontSize: 12,
                        fontFamily: fontbody,
                        color: notifier.getbluewhitecolor,
