...
import 'package:trovo_app/bottom_bar/bottom_pages/confirm_swap.dart';
import 'package:trovo_app/bottom_bar/bottom_pages/change_password.dart';
import 'package:trovo_app/bottom_bar/bottom_pages/payment_detail.dart';
import 'package:trovo_app/bottom_bar/bottom_pages/payment_history.dart';
import 'package:trovo_app/bottom_bar/bottom_pages/profile_details.dart';
import 'package:trovo_app/bottom_bar/bottom_pages/referral_info.dart';
import 'package:trovo_app/bottom_bar/bottom_pages/share_receipt.dart';
import 'package:trovo_app/bottom_bar/bottom_pages/subwallet_create_success.dart';
...
import 'package:trovo_app/screens/account_recovery/complete_account_recovery.dart';
import 'package:trovo_app/screens/account_recovery/disable_account_recovery.dart';
import 'package:trovo_app/screens/account_recovery/disable_account_recovery_info.dart';
import 'package:trovo_app/screens/account_recovery/recover_account.dart';
import 'package:trovo_app/screens/account_recovery/request_backup.dart';
import 'package:trovo_app/screens/account_recovery/security_questions_for_inactive_accounts.dart';
import 'package:trovo_app/screens/account_recovery/setup_account_recovery.dart';
import 'package:trovo_app/screens/auth/authorize_action_view.dart';
import 'package:trovo_app/screens/auth/authorize_login_view.dart';
import 'package:trovo_app/screens/auth/create_password.dart';
import 'package:trovo_app/screens/auth/get_started.dart';
import 'package:trovo_app/screens/auth/signup.dart';
import 'package:trovo_app/screens/auth/verification.dart';
import 'package:trovo_app/screens/backup/backup_all.dart';
import 'package:trovo_app/screens/backup/congratulation.dart';
import 'package:trovo_app/screens/backup/ensure_privacy.dart';
import 'package:trovo_app/screens/send_and_recieve/asset_details.dart';
...
import 'package:trovo_app/screens/send_and_recieve/request_specific_payment_details.dart';
import 'package:trovo_app/screens/send_and_recieve/request_specific_payment.dart';
...
import 'package:trovo_app/screens/announcements/announcements_view.dart';
import 'package:trovo_app/screens/asset-tokenization/asset_dashboard.dart';
import 'package:trovo_app/screens/asset-tokenization/asset_information.dart';
import 'package:trovo_app/screens/asset-tokenization/asset_subscribers.dart';
import 'package:trovo_app/screens/asset-tokenization/asset_token_information.dart';
import 'package:trovo_app/screens/asset-tokenization/asset_verification_documents.dart';
import 'package:trovo_app/screens/asset-tokenization/buy_tokens.dart';
...
import 'package:trovo_app/screens/market_trade/market_pairs.dart';
import 'package:trovo_app/screens/market_trade/market_trade.dart';
import 'package:trovo_app/screens/market_trade/market_trade_info.dart';
...
import 'package:trovo_app/screens/p2p/p2p_payment_methods_view.dart';
...
import 'package:trovo_app/screens/shared_access/shared_wallet_info.dart';
import 'package:trovo_app/screens/shared_access/update_shared_access.dart';
import 'package:trovo_app/screens/shared_access/update_shared_access_details.dart';
import 'package:trovo_app/screens/shared_access/welcome_to_shared_access.dart';
import 'package:trovo_app/screens/subscriptions/authorize_subscription.dart';
import 'package:trovo_app/screens/subscriptions/subscription_benefits.dart';
    ...
    if (shouldAddPage) {
      switch (pageConfig.uiPage) {
        ...
        case Pages.ProceedsPayOutView:
          _addPageData(ProceedsPayOut(), ProceedsPayOutViewPageConfig);
          break;
        ...
        case Pages.P2PEditOfferView:
          ...
          break;
        case Pages.P2PPaymentMethodsView:
          _addPageData(P2PPaymentMethodsView(), P2PPaymentMethodsViewPageConfig);
          break;
        default:
          break;
      }
  ...
  void _setPageAction(PageAction action) {
    switch (action.page?.uiPage) {
      ...
      case Pages.TotalSalesView:
        ...
        break;
      case Pages.ProceedsPayOutView:
        ProceedsPayOutViewPageConfig.currentPageAction = action;
        break;
      case Pages.LiquidateAssetView:
      ...
      case Pages.AssetTokenDetailsView:
        AssetTokenDetailsViewPageConfig.currentPageAction = action;
        break;
      case Pages.ConfirmTokenizationDetailsView:
        ConfirmTokenizationDetailsViewPageConfig.currentPageAction = action;
        break;
      case Pages.TokenizationFeePaymentView:
      ...
      case Pages.P2PEditOfferView:
        ...
        break;
      case Pages.P2PPaymentMethodsView:
        P2PPaymentMethodsViewPageConfig.currentPageAction = action;
        break;
      default:
        break;
    }
