...
class _LoginState extends State<Login> {
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Divider(color: notifier.getgrey, height: 50),
                        ),
                      ),
                      Text(
                        "oR".tr(),
  ...
  versionControl() async {
    ...
    if (appVersionData.isNotEmpty) {
      ...
      String minVersion = await appVersionData['minVersion'].replaceAll(
        '.',
        '',
      );

      String currentVersion = await appVersionData['version'].replaceAll(
        '.',
        '',
      );
