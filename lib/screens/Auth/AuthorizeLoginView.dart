...
class AuthorizeLoginView extends StatefulWidget {
  const AuthorizeLoginView({Key? key}) : super(key: key);

  @override
  State<AuthorizeLoginView> createState() => _AuthorizeLoginViewState();
}

class _AuthorizeLoginViewState extends State<AuthorizeLoginView> {
  ...
  authorize() async {
    ...
    try {
      ...
      Map responseData = await makePostRequest(
        uri:
            '/v1/users/servicelinks/login/approval/${viewData['targetUser']}?ownerUsername=${viewData['ownerUsername']}&loginId=${viewData['loginId']}',
        body: "",
