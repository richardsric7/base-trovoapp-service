...
class _AssetDashboardState extends State<AssetDashboard>
  ...
  Widget build(BuildContext context) {
    ...
    _amountRaised =
        (tokenizedAsset.quantityOfTokensSold ?? 0) *
                          ...
                          child: Row(
                            ...
                            children: [
                              infoCard(
                                ...
                                value:
                                    '${tokenizedAsset.numberOfExpressedInterests} users',
                              ),
                              infoCard(
                                notifier,
                                label: 'Purchase Commitments',
                                value:
                                    '${getFiatValue(tokenizedAsset.purchaseCommitments ?? 0)} ${tokenizedAsset.assetQuoteCurrency}',
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Row(
                            ...
                            children: [
                              infoCard(
                                ...
                                value:
                                    '${tokenizedAsset.numberOfSubscribers} Users',
                              ),
                              infoCard(
                                notifier,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: height / 50),
                                    if (tokenizedAsset.tokenizationStatus ==
                                        5) ...[
                                      Column(
                                        crossAxisAlignment:
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    SizedBox(height: 10),
                                    if (tokenizedAsset.assetAlreadyExists ==
                                        0) ...[
                                      categoryTile(
                                        notifier,
                                        label: 'Asset Financial Information',
                                        imageUrl:
                                            'assets/images/stakeholders.png',
                                        onTap: () {
                                          var details = {
                                    ...
                                    categoryTile(
                                      ...
                                      imageUrl: 'assets/images/proof.png',
                                      onTap: () {
                                        displayProofOfPaymentDocuments(
          ...
          builder: (context, scrollController) {
            return SingleChildScrollView(
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 14.0),
                child: Column(
                  crossAxisAlignment: documents.isNotEmpty
                      ? CrossAxisAlignment.start
  ...
  void displayProofOfPaymentDocuments(
    String label,
    List<ProofOfPaymentDocument> documents,
  ) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
