...
type PaymentItem struct {
	...
	SourceContractAddress      string    `json:"sourceContractAddress"`      //for path payment
	DestinationAssetCode       string    `json:"destinationAssetCode"`       //for path payment
	DestinationContractAddress string    `json:"destinationContractAddress"` //for path payment
