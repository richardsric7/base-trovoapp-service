...
func main() {
...

	{
		...
		requiredEnvironmentVariables := []string{"EXPANSION_URL", "BLOCKCHAIN_NETWORK_PASSPHRASE",
			...
			"IPAPI_KEY", "IPAPI_HOST", "REWARD_FAUCET", "REWARD_ISSUER",
			"REWARD_ASSET_CODE", "ENABLE_REFERRAL_REWARD", "REFERRAL_REWARD_AMOUNT", "ENABLE_EMAIL_VALIDATION", "ENABLE_CACHING",
			"REDIS_HOST", "REDIS_PORT", "REDIS_PASSWORD", "DYNAMIC_LINKS_API_KEY", "DYNAMIC_LINKS_DOMAIN_PREFIX", "DYNAMIC_LINKS_ANDROID_PACKAGE_NAME",
			"DYNAMIC_LINKS_IOS_BUNDLE_ID", "DYNAMIC_LINKS_FALLBACK_BASE_URL", "FBDL_SERVICE_URLS"}
