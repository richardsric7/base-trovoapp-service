...
import { CustodianDashboardSummary } from "@/redux/api/assetCustodian";
import AcStatsGrid from "./AcStatsGrid";

interface AcDashboardHeaderProps {
  summary?: CustodianDashboardSummary;
}

const AcDashboardHeader = ({ summary }: AcDashboardHeaderProps) => {
  ...
  return (
    <Wrapper>
      ...
      <AcStatsGrid summary={summary} />
    </Wrapper>
  );
};

export default AcDashboardHeader;
