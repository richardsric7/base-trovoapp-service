...
const AssignedStakeHolder: React.FC<AssignedStakeHolderProps> = ({
  ...
  const assignedName = (role: string, fallback: string) =>
    stakeholders?.find((item) => item.role === role)?.organization_name ||
    fallback;
  ...
  const stakeHoldersData = [
    {
      ...
      name: assignedName("asset_custodian", dummyStakeholders.assetCustodian),
    },
    {
      id: 2,
      title: "Asset Manager",
      name: assignedName("asset_manager", dummyStakeholders.assetManager),
    },
    {
      id: 3,
      title: "Regulator",
    ...
    },
    {
      id: 4,
      title: "Issuing House",
      name: assignedName("asset_issuing_house", dummyStakeholders.issuingHouse),
    },
    {
      id: 5,
      title: "Legal Adviser",
    ...
    },
    {
      id: 6,
      title: "Rating Agency",
      name: assignedName("rating_agency", dummyStakeholders.ratingAgency),
    },
    {
      id: 7,
      title: "Trustee",
      name: assignedName("trustee", dummyStakeholders.trustee),
    },
  ];
