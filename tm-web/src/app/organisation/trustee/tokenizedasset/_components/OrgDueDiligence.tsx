...
const DueDiligenceTab = ({ assetId, documents = [] }: Props) => {
  ...
  const documentCount = new Set(documents.map((document) => document.id)).size;
  ...
  return (
    <>
      <Container>
        ...
        <DueDiligenceScore documentCount={documentCount} />
