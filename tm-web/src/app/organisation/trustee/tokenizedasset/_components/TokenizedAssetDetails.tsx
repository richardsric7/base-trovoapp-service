  ...
  const handleMenuClick: MenuProps["onClick"] = ({ key }) => {
    switch (key) {
      case "1": // Primary Sale Details
        router.push("/organisation/trustee/tokenizedasset/primarysalesdetails");
        break;
      case "2": // Commitment Details
        router.push("/organisation/trustee/tokenizedasset/commitment-details");
        break;
      case "3": // View Token Holders
        router.push("/organisation/trustee/tokenizedasset/tokenholders");
        break;
      case "4": // Early Exit
        router.push("/organisation/trustee/tokenizedasset/earlyexit");
        break;
      case "5": // Asset Income Report
        router.push("/organisation/trustee/tokenizedasset/assetincomereport");
        break;
    ...
    <TokenizationStep>
      ...
      <Section>
        <HeadingContent>
          ...
          {showActions && <ButtonContainer>
            {/* <PrimaryButton
              buttonStyle={{ width: "154px" }}
              // onClick={() => {
              //   router.push("/organisation/trustee/tokenizedasset/dividendandyield");
              // }}
            >
              Authorize
            </PrimaryButton> */}
