...
import { TrusteeRecentActivity } from "@/redux/api/trustees";
import { getInitials } from "@/utils/getInitials";

interface RecentActivityProps {
  activities?: TrusteeRecentActivity[];
}

const TRecentActivity = ({ activities = [] }: RecentActivityProps) => {
  return (
    <Container>
...
const StatusDot = styled.div<{ $status?: string }>`
  ...
  border-radius: 50%;
  background: ${({ $status }) =>
    $status === "complete" || $status === "active" || $status === "approved"
      ? "#00A859"
