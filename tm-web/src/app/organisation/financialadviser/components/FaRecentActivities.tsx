...
import { FaRecentActivity } from "@/redux/api/financialAdviser";

interface RecentActivityProps {
  activities?: FaRecentActivity[];
}

const FaRecentActivities = ({ activities = [] }: RecentActivityProps) => {
  return (
    <Container>
...
export default FaRecentActivities;
