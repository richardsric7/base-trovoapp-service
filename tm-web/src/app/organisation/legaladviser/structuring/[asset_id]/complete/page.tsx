...
import { useCompleteAssetStructuringMutation } from "@/redux/api/legalAdviser";
...
const CompleteStructuringPage = () => {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      router.push("/organisation/legaladviser");
    } catch (error) {
  ...
  return (
    <Page>
      ...
      <Card>
        ...
        <Subtitle>
          Submit the legal structuring document to mark this asset as
          structured.
        </Subtitle>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Field>
            ...
            <TextInput
              ...
              onChange={(event) => setField("document_id", event.target.value)}
            />
          </Field>
