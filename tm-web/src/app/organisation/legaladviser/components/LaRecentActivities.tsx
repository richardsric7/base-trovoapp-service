...
import { LaRecentActivity } from "@/redux/api/legalAdviser";

interface RecentActivityProps {
  activities?: LaRecentActivity[];
}

const LaRecentActivities = ({ activities = [] }: RecentActivityProps) => {
  return (
    <Container>
...
export default LaRecentActivities;
