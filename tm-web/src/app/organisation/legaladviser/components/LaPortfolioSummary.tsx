...
import { LaPortfolioSummary } from "@/redux/api/legalAdviser";

const Chart = dynamic(() => import("react-apexcharts"), { ssr: false });

interface PortfolioSummaryProps {
  summary?: LaPortfolioSummary;
}

const LaPortfolioSummaryComponent = ({ summary }: PortfolioSummaryProps) => {
...
export default LaPortfolioSummaryComponent;
