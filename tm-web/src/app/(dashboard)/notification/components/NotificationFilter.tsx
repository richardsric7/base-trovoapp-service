...
const NotificationFilter = () => {
  ...
  const filterCriteria = {
    NotificationType: ["All", "Support", "Compliance"],
    Recipients: ["All", "admins", "users"],
    Deliverystatus: ["All", "Deliverd", "Not Deliverd"],
  };
      ...
      {openFilter && (
        <FilterContainer>
          ...
          <FilterContent>
            ...
            <DropdownSelect
              options={filterCriteria.NotificationType}
              placeholder="All"
              labelText="NotificationType"
              value={selectValues["NotificationType"] || ""}
              onSelect={(item) =>
                setSelectValues({ ...selectValues, NotificationType: item })
              }
            />

            {/* Recipients Filter */}
            <DropdownSelect
              options={filterCriteria.Recipients}
              placeholder="All"
              labelText="Recipients"
              value={selectValues["Recipients"] || ""}
              onSelect={(item) =>
                setSelectValues({ ...selectValues, Recipients: item })
              }
            />

            {/* Delivery  Filter */}
            <DropdownSelect
              options={filterCriteria.Deliverystatus}
              placeholder="All"
              labelText="Delivery Status"
              value={selectValues["Deliverystatus"] || ""}
              onSelect={(item) =>
                setSelectValues({ ...selectValues, Deliverystatus: item })
              }
            />

            {/* Date Selection */}
            <div>
              <SelectText>Selected Date</SelectText>
