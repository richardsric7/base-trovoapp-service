...
import adminAvatar from "@/assets/images/8.png";
import Tab from "@/components/Tab";
import { IoLocationOutline } from "react-icons/io5";
import statusIcon from "@/assets/images/status.svg";
import statusIcons from "@/assets/images/status-green.svg";
...
const SuspendedUserPage = () => {
  ...
  const [revokeSuspension, setRevokeSuspension] = useState<boolean>(false);
        ...
        <div>
          <UserInfoContainer>
            ...
            <div style={{ position: "relative" }}>
              <MenuTrigger onClick={() => setShowActions(!showActions)}>
                <BsThreeDotsVertical />
              </MenuTrigger>
