...
const AssetRecordsFilter = () => {
  ...
  const filterCriteria = {
    authenticationMthod: ["Active", "Suspended"],
    ...
    <>
      ...
      >
        <FilterContent>
          {/* PaymentTypeFilter */}
          <DropdownSelect
            options={filterCriteria.authenticationMthod}
            labelText="Authentication Method"
            placeholder="All"
            value={selectValues["authenticationMethod"] || ""}
            onSelect={(item) =>
              setSelectValues({ ...selectValues, authenticationMethod: item })
            }
          />
          {/* Date Selection */}
          <div>
            <SelectText>Login Date</SelectText>
...
export default AssetRecordsFilter;
