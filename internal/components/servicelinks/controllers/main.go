...
func Init(router *gin.Engine, gc *sharedconfig.GlobalConfig) {
	...
	router.GET("/v1/trovo-api/users/balance/:walletPublicKey", middleware.AuthenticationMiddlewareUsingAPIKey(gc), func(c *gin.Context) {
	...
	router.POST("/v1/trovo-api/users/payment", middleware.AuthenticationMiddlewareUsingAPIKey(gc), func(c *gin.Context) {
	...
	router.GET("/v1/trovo-api/assets/marketplace/list", middleware.AuthenticationMiddlewareUsingAPIKey(gc), func(c *gin.Context) {
